class MenuScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image('background', 'assets/images/spacebg.jpg');
  }
...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image('player', 'assets/images/shiph.png');
    this.load.image('laser', 'assets/images/projectile.png');
    ...
    this.load.audio('shoot-sound', 'assets/sounds/laser-fire.mp3');
    this.load.audio('collision-sound', 'assets/sounds/pop.mp3');
  }

  create() {
    this.add.image(400, 300, 'background').setDisplaySize(800, 600);
    this.player = this.physics.add.sprite(400, 500, 'player').setScale(0.4).setCollideWorldBounds(true);
    ...
    this.lastFired = 0;
    this.asteroidTextures = ['asteroid1', 'asteroid2'];
  ...
  shootProjectile() {
    let laser = this.projectiles.create(this.player.x, this.player.y - 20, 'laser');
